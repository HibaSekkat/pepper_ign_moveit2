...
: ${AMENT_CURRENT_PREFIX:="/root/ws/src/pepper_ign_moveit2/pepper_robot_moveit_config/install/pepper_robot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pepper_robot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pepper_robot_moveit_config/environment/path.sh"
