...
def generate_launch_description() -> LaunchDescription:
    ...
    nodes = [
        ...
        # ros_ign_bridge (ground truth robot pose -> ROS 2)
        Node(
            package="ros_ign_bridge",
            executable="parameter_bridge",
            output="log",
            arguments=[
                "/model/pepper_robot/pose"
                + "@"
            ...
            parameters=[{"use_sim_time": use_sim_time}],
            remappings=[("/model/pepper_robot/pose", "/tf")],
        ),
        # Static tf remapping for footprint
        Node(
            package="tf2_ros",
            ...
            arguments=[
                ...
                "pepper_robot",
                # "--child-frame-id",
                #"robot_summit_xl_base_footprint",
                "--ros-args",
                "--log-level",
                log_level,
            ],
    ...
    return [
        ...
        DeclareLaunchArgument(
            ...
            default_value=path.join(
                get_package_share_directory("pepper_robot_ign"),
                "worlds",
                "follow_target.sdf",
            ),
