...
from robots import pepper_robot
...
class MoveItFollowTarget(Node):
    def __init__(self):
        ...
        self._moveit2 = MoveIt2(
            node=self,
            joint_names=pepper_robot.joint_names(),
            base_link_name=pepper_robot.base_link_name(),
            end_effector_name=pepper_robot.end_effector_name(),
            group_name=pepper_robot.MOVE_GROUP_ARM,
